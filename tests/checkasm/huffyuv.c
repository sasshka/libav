...
static void check_huffyuv(HuffYUVDSPContext c, int width)
{
    ...
    if (check_func(c.add_bytes, "huffyuv_add_bytes")) {
...
void checkasm_check_huffyuv_add_bytes(void)
{
    HuffYUVDSPContext c;
