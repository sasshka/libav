...
static int rv30_parse_slice_header(RV34DecContext *r, BitstreamContext *bc, SliceInfo *si)
{
 ...
 */
static int rv30_decode_intra_types(RV34DecContext *r, BitstreamContext *bc, int8_t *dst)
{
    int i, j, k;
