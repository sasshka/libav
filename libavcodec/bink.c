...
#define GET_HUFF(bc, tree)  (tree).syms[bitstream_read_vlc(bc, bink_trees[(tree).vlc_num].table,\
 ...
 */
static int read_dct_coeffs(BitstreamContext *bc, int32_t block[64], const uint8_t *scan,
        ...
        for (bx = 0; bx < bw; bx++, dst += 8) {
            ...
            case 1:
                ...
                do {
                    ...
                    run = bitstream_read(bc, binkb_runbits[i]) + 1;
