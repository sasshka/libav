...
static void mp_read_changes_map(MotionPixelsContext *mp, BitstreamContext *bc, int count, int bits_len, int read_color)
{
    uint16_t *pixels;
...
static void mp_get_code(MotionPixelsContext *mp, BitstreamContext *bc, int size, int code)
{
...
static void mp_decode_frame_helper(MotionPixelsContext *mp, BitstreamContext *bc)
{
    YuvPixel p;
    int y, y0;
