...
; the add_res macros and functions were largely inspired by x264 project's code in the h264_idct.asm file
...
; void ff_hevc_add_residual_8_8_<opt>(uint8_t *dst, int16_t *coeffs, ptrdiff_t stride)
