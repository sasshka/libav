...
cglobal hevc_idct_transpose_8x8_%1, 0, 0, 0
    ; M1 M2 ^T = M1^t M3^t
    ; M3 M4      M2^t M4^t
...
cglobal hevc_idct_transpose_16x16_%1, 0, 0, 0
...
cglobal hevc_idct_16x16_%1, 1, 2, 16, coeffs
    mov r1, 4
    .loop16:
    TR_16x4 (8 * r1 - 8), 7, [pd_64], 64, 2, 32, 8, 16, 1, 0
    dec r1
    jg .loop16
    ...
    mov r1d, 4
.loop16_2:
    TR_16x4 (8 * r1 - 8), shift, [arr_add], 64, 2, 32, 8, 16, 1, 1
    dec r1d
    jg .loop16_2
    call transpose_16x16
...
%macro TRANSPOSE_32x32 1
cglobal hevc_idct_transpose_32x32_%1, 0, 0, 0
    ; M0  M1 ... M7
    ; M8         M15
    ;
    ; ...
...
%if %1 == 8
TRANSPOSE_8x8 sse2
TRANSPOSE_16x16 sse2
TRANSPOSE_32x32 sse2
%endif
