...
void ff_hevc_idct_4x4_8_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_4x4_10_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_8x8_8_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_8x8_10_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_16x16_8_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_16x16_10_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_32x32_8_sse2(int16_t *coeffs, int col_limit);
void ff_hevc_idct_32x32_10_sse2(int16_t *coeffs, int col_limit);
